...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc_f4(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2','ch3','ch4']
        ...
        self.mode      = mode
        self.anomCoupSearchWindows = {'dkg':['-0.025','0.025'],
                                      'dg1':['-0.025','0.025'],
                                      'lZ' :['-0.025','0.025']     }
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        filename = '%s/signal_%s_f4.root'%(basepath,lepchannel)  
        print ' ===============> using file %s/signal_%s_f4.root'%(basepath,lepchannel) 

              
#        f = r.TFile('%s/mu_boosted.root'%basepath,'READ')
        print ' ===============> using file %s/%s_boosted_withSignalSyst_adjustedUnc_f4.root'%(basepath,lepchannel)
        f = r.TFile('%s/%s_boosted_withSignalSyst_adjustedUnc_f4.root'%(basepath,lepchannel),'READ')
...
dkglZModel_wz_adjustedUnc_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc_f4('dkglZ')
dg1lZModel_wz_adjustedUnc_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc_f4('dg1lZ')
dkgdg1Model_wz_adjustedUnc_f4 = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc_f4('dkgdg1')
