...
#        self.lepchannels  = ['ch1','ch2','ch3','ch4']
        self.lepchannels  = ['l4','l2nu2']
#        self.lepchannels  = ['l4']
#        self.lepchannels  = ['l2nu2']
        self.pois      =  ['dkg','dg1','lZ']
        self.mode      = mode
        self.anomCoupSearchWindows = {'dkg':['-0.03','0.03'],
                                      'dg1':['-0.03','0.03'],
                                      'lZ' :['-0.03','0.03']     }
...
#        f = r.TFile('%s/%s_boosted.root'%(basepath,lepchannel),'READ')
        print '==========================> using file %s/%s_boosted_withSignalSyst.root'%(basepath,lepchannel)
        f = r.TFile('%s/%s_boosted_withSignalSyst.root'%(basepath,lepchannel),'READ')
