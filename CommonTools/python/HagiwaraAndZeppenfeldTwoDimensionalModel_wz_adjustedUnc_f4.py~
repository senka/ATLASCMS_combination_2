...
class HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc(AnomalousCouplingModel):
...
#        self.lepchannels  = ['ch1','ch2','ch3','ch4']
    ...
    def buildScaling(self,process,channel,lepchannel):        
        ...
        filename = '%s/signal_%s_f5.root'%(basepath,lepchannel)  
        print ' ===============> using file %s/signal_%s_f5.root'%(basepath,lepchannel) 

              
#        f = r.TFile('%s/mu_boosted.root'%basepath,'READ')
        print ' ===============> using file %s/%s_boosted_withSignalSyst_adjustedUnc.root'%(basepath,lepchannel)
        f = r.TFile('%s/%s_boosted_withSignalSyst_adjustedUnc.root'%(basepath,lepchannel),'READ')
...
dkglZModel_wz_adjustedUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc('dkglZ')
dg1lZModel_wz_adjustedUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc('dg1lZ')
dkgdg1Model_wz_adjustedUnc = HagiwaraAndZeppenfeldTwoDimensionalModel_wz_adjustedUnc('dkgdg1')
