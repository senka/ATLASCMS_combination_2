...
background_{codename}boosted_backshape          lnN      -            """.format(codename=codename)
        for i in range(0,Nbkg_int):
            card += """\t\t\t\t1.3"""
        card += """           
signal_th          lnN      1.04            """.format(codename=codename)
        for i in range(0,Nbkg_int):
            card += """\t\t\t\t-"""
...
background_MC_syst        lnN     -                           {err_up}                             -""".format(leptons=leptons,codename=codename,err_down=syst_bkgMC_err_rel_Down[ch],err_up=syst_bkgMC_err_rel_Up[ch])
        ...
        if (leptons=="l2nu2"):
            card += """
{leptons}_{codename}_background_DD_factor2p5_stat        lnN     -                           -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=stat_bkgDD_err_rel_Down[ch],err_up=stat_bkgDD_err_rel_Up[ch])
...
{leptons}_{codename}_signal_stat       lnN     {err_up}                           -                             -""".format(leptons=leptons,codename=codename,err_down=stat_signal_err_rel_Down[ch],err_up=stat_signal_err_rel_Up[ch])
            card += """
signal_reco       lnN     {err_up}                           -                             -""".format(leptons=leptons,codename=codename,err_down=syst_signal_reco_err_rel_Down[ch],err_up=syst_signal_reco_err_rel_Up[ch])
            card += """
...
#lumi_8TeV           lnN     {err_up}39                                       {err_up}39                           -
