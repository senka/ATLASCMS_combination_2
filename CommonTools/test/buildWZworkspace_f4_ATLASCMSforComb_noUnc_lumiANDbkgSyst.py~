...
#                print background_shapeSyst[j][i],"   ~~~~~~~~~~~ not correlated"
#                card += """
...
#            else:
#                print background_shapeSyst[j][i],"   ~~~~~~~~~~~ correlated"
#                name_forCorr=str(background_shapeSyst[j][i])
#                if ('_DD_syst' in name_forCorr and ('ch1' in name_forCorr or 'ch3' in name_forCorr)):
#                    name_forCorr=name_forCorr.replace('l2nu2_','')                    
#                    name_forCorr=name_forCorr.replace('l4_','')                    
#                    name_forCorr=name_forCorr.replace('ch1_','odd_')                    
...
#                    name_forCorr=name_forCorr.replace('ch3_','')
#                    name_forCorr=name_forCorr.replace('ch4_','')
#                print ' ------> in datacard ',name_forCorr
#                card += """
...
#                card += """-\t\t\t\t""".format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
 ...
 #           if ("_factor1p5" in background_shapeSyst[j][i]):
#                card += """1.5 """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
#            elif("_factor2p5" in background_shapeSyst[j][i]):
#                card += """2.5 """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
#            else:    
...
#                card += """\t\t\t\t-""".format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
    ...
    if (doSignalShape_unc):
        for i in range(0,len(signal_shapeSyst)):
            if not(isItCorrelated(str(signal_shapeSyst[i]))):
                card += """
