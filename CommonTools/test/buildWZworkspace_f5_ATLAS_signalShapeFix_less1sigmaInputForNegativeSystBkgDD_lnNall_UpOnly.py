...
#for i in range(0,7):
#    syst_signal_reco_err[i]=sqrt(syst_signal_reco_err[i]*syst_signal_reco_err[i]+syst_signal_th_err[i]*syst_signal_th_err[i])
...
syst_signal_sum_err = []
syst_signal_sum_err_rel_Up = []
syst_signal_sum_err_rel_Down = []
for i in range(0,7):
    syst_signal_sum_err.append([])
    syst_signal_sum_err_rel_Up.append([])
    syst_signal_sum_err_rel_Down.append([])
    print i
    syst_signal_sum_err[i]=sqrt(syst_signal_reco_err[i]*syst_signal_reco_err[i]+syst_signal_th_err[i]*syst_signal_th_err[i])
  
    syst_signal_sum_err_rel_Up[i]=1.+syst_signal_sum_err[i]/l2nu2_signal[i]
    syst_signal_sum_err_rel_Down[i]=1.-syst_signal_sum_err[i]/l2nu2_signal[i]
...
#    card += """
#{leptons}_{codename}_background_MC_stat        lnN     -                           {err_up}                             -""".format(leptons=leptons,codename=codename,err_down=stat_bkgMC_err_rel_Down[ch],err_up=stat_bkgMC_err_rel_Up[ch])
#    card += """
#background_MC_syst        lnN     -                           {err_up}                             -""".format(leptons=leptons,codename=codename,err_down=syst_bkgMC_err_rel_Down[ch],err_up=syst_bkgMC_err_rel_Up[ch])
...
background_MC_syst        lnN     -                           {err_up}                             -""".format(leptons=leptons,codename=codename,err_down=syst_bkgMC_err_rel_Down[ch],err_up=syst_bkgMC_err_rel_Up[ch])
        ...
        card += """
{leptons}_{codename}_background_DD_to0exp_stat        lnN     -                           -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=stat_bkgDD_err_rel_Down[ch],err_up=stat_bkgDD_err_rel_Up[ch])

        if (codename_forBKGDDsyst=="odd"):
            card += """
odd_background_DD_syst       lnN     -                           -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=syst_bkgDD_err_rel_Down[ch],err_up=syst_bkgDD_err_rel_Up[ch])
        else:
            card += """
even_background_DD_syst       lnN     -                           -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=syst_bkgDD_err_rel_Down[ch],err_up=syst_bkgDD_err_rel_Up[ch])
        card += """
{leptons}_{codename}_signal_stat       lnN     {err_up}                           -                             -""".format(leptons=leptons,codename=codename,err_down=stat_signal_err_rel_Down[ch],err_up=stat_signal_err_rel_Up[ch])
        card += """
signal_recoth       lnN     {err_up}                           -                             -""".format(leptons=leptons,codename=codename,err_down=syst_signal_sum_err_rel_Down[ch],err_up=syst_signal_sum_err_rel_Up[ch])
#        card += """
#signal_th       lnN     {err_up}                           -                             -""".format(leptons=leptons,codename=codename,err_down=syst_signal_th_err_rel_Down[ch],err_up=syst_signal_th_err_rel_Up[ch])

    else:
        card += """
{leptons}_{codename}_background_DD_factor1p5_stat        lnN     -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=stat_bkgDD_err_rel_Down[ch],err_up=stat_bkgDD_err_rel_Up[ch])
