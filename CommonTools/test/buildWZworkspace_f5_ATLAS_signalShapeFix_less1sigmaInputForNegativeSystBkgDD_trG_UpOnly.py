...
background_MC_syst        trG     -                           {err_up}                             -""".format(leptons=leptons,codename=codename,err_down=syst_bkgMC_err_rel_Down[ch],err_up=syst_bkgMC_err_rel_Up[ch]-1.)
        ...
        card += """
{leptons}_{codename}_background_DD_to0exp_stat        trG     -                           -                             {err_up}""".format(leptons=leptons,codename=codename,err_down=stat_bkgDD_err_rel_Down[ch],err_up=stat_bkgDD_err_rel_Up[ch]-1.)
