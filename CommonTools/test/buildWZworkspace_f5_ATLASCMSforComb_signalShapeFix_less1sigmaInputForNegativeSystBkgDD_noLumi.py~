...
{background_shapeSyst} shape  """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=name_forCorr)
            ...
            if ("_factor1p5" in background_shapeSyst[j][i]):
                card += """1.335 """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
            elif("_factor2p5" in background_shapeSyst[j][i]):
                card += """1.845 """.format(codename=codename,norm_sig_sm=norm_sig_sm,norm_bkg=norm_bkg,norm_obs=norm_obs,i=i,background_shapeSyst=background_shapeSyst[j][i])
            else:    
